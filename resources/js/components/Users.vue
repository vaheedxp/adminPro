                ...
                <div class="card card-default">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <button type="button" class="btn btn-primary btn-sm" @click="showAddModal()"> <i class="fa fa-user-plus"></i> Add User</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <tr v-for="u in users.data" :key="u.id">
                                    ...
                                    <td>
                                        <a href="#" @click="showEditModal(u)"><i class="fa fa-edit c-green"></i></a>
                                        <a href="#" @click="deleteUser(u.id)"><i class="fa fa-trash c-red"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <form @submit.prevent="modalMode ? updateUser() : createUser()" @keydown="form.onKeydown($event)">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label>Job:</label>
                                    <input v-model="form.job" type="text" name="job" placeholder="Job Title"
                                        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('job') }">
                                    <has-error :form="form" field="job"></has-error>
                                </div>
                                <div class="form-group">
                                    <label>User Type:</label>
                                    <select v-model="form.type" name="type" placeholder="Select User Role"
                                        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('password') }">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea v-model="form.bio" id="bio" name="bio" placeholder="Write your short bio (Optional)" rows="5"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label>Notes:</label>
                                    <textarea v-model="form.notes" id="notes" name="notes" placeholder="Optional Notes (Optional)" rows="5"
                                        class="form-control form-control-sm" :class="{ 'is-invalid': form.errors.has('notes') }"></textarea>
                    ...
                    <div class="modal-footer">
                        <button v-show="!modalMode" type="button" class="btn btn-success btn-sm" @click="resetForm()">Reset Form</button>
      ...
      this.form
        ...
        .catch(err => {
          toast({
            type: "warning",
            title:
              "Sorry! Somting was wrong. The user was not created. Try again!"
          });
        });
    },
    updateUser() {
